    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voucher_number', models.IntegerField(default=vouchers.models.get_voucher_number, verbose_name='Vch No.')),
                ...
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='voucher', to='masters.gst_state')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=2, max_digits=16)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='particular', to='masters.category')),
                ('metal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='particular', to='masters.metal')),
                ('purity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='particular', to='masters.purity')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='particular', to='masters.type')),
                ('voucher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='particular', to='vouchers.voucher')),
            ],
        ),
    ]
