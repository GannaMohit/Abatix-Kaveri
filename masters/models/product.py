...
class Metal(models.Model):
    ...
    melting_point = models.DecimalField(max_digits=16, decimal_places=2, blank=True)
    boiling_point = models.DecimalField(max_digits=16, decimal_places=2, blank=True)
    density = models.DecimalField(max_digits=16, decimal_places=2, blank=True)
...
class Type(models.Model):
    ...
    hsn = models.ForeignKey(HSN, on_delete=CASCADE, related_name="types")
