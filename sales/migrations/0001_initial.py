    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advance_number', models.IntegerField(default=sales.models.advance.get_advance_number, verbose_name='Adv. No.')),
                ...
                ('state', models.ForeignKey(default=sales.models.advance.get_gst_state, on_delete=django.db.models.deletion.CASCADE, related_name='advances', to='masters.gst_state')),
            ],
        ),
        migrations.CreateModel(
            name='Home_Sale',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.ForeignKey(default=sales.models.invoice.get_gst_state, on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='masters.gst_state', verbose_name='state')),
            ],
        ),
        migrations.CreateModel(
            name='Untagged',
